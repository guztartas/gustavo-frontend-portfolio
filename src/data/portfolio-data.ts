...
export const portfolioData = {
  ...
  skills: [
    ...
    },
    {
      ...
      items: ["Redux-Saga", "MobX", "Context API", "Zustand", "Clean Architecture"],
    },
    {
      title: "Backend & APIs",
      items: ["Node.js", "Express", "REST APIs", "GraphQL", "WebSocket", "Java", "Nest.js"],
    },
    {
      title: "Quality & AI",
      items: [
  ...
  languages: ["Portuguese (Native)", "English (Highly proficient)", "Spanish (Working knowledge)"],
  contacts: {
